...
- `output/tumor_tree_pipeline/input_20260820/manifest.json` 與 `input_qa.json` 是目前 canonical table 的小型 provenance/QA receipt；大型 `likelihood_input.tsv.gz` 仍是 ignored generated input。manifest 中的外部 source path 只作 lineage，未刪除。
