...
slides = [
    ...
    ("Canonical SNV row", "同一列同時保留 identity、reads、purity 與 copy number",
     ...
     "slide-3-canonical-fields", ["assets/components/snv_identity_record.svg", "assets/components/read_pileup.svg", "assets/components/cn_segment_context.svg", "assets/components/purity_mixture.svg"], [],
